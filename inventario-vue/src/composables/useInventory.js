// CÓDIGO COMPLETO Y ESTABLE para: src/composables/useInventory.js
...
export function useInventory() {
  ...
  const loadFromLocalStorage = () => {
    ...
    _productsWithSku.value = storedProducts ? JSON.parse(storedProducts) : {
      "PALE 1200X800 C.81 LOGIFRUIT": { sku: "LOGIFRUIT81" }, "CAJA PLAST IFCO 400X300 A-162 RF.BLL4314": { sku: "BLACK4314" }, "CAJA PLST LOGIFRUIT 400X300 A-160 RF.316": { sku: "LOGIFRUIT316" }, "CAJA PLAST IFCO 400X300 A-119 RF.BLL4310": { sku: "BLACK4310" }, "CAJA PLAST EUROPOOL 400X300 A150 RF.154": { sku: "154CAJAVERDE" }, "TARR. CILIN. PIÑA - PURA PIÑA - T1296": { sku: "PURAPIÑA" }, "TARR. CILIN. PIÑA - ALDI - T1296": { sku: "ALDI1" }, "TARR. CILIN. PIÑA - DEL MONTE - T1296": { sku: "DELMONTE" }, "TARR. CILIN. PIÑA - MERCADONA - T1296": { sku: "HACENDADO1" }, "TAPA TARRINA CILINDRO PINA": { sku: "TAPAPIÑA" }, "TARRINA REDONDA D97,5 - H75 - T1398": { sku: "TARRINA97,5" }, "CAJA CARTON 320X230 A-125 VERDE LIDL": { sku: "MONTADA A-125" }, "TARRINA REDONDA D119 - H73,5 - T1835": { sku: "TARRINA119" }, "TARR. RED. D97,5-H100-T1398 ZANAH.PALITO": { sku: "TARRINA ZANAHORIA" }, "TARRINA K 2187-1AF": { sku: "TARRINA 1AF" },
    };
